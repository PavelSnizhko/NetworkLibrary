...
final class NetworkFacadeTests: XCTestCase {
    ...
    func testExecuteWithDecoding() {
        ...
        let requestDataWithBody = RequestMetaData(endpoint: "https://jsonplaceholder.typicode.com/post/1",
                                                  method: .get,
                                                  body: jsonData,
                                                  headers: nil)
        ...
        let requestDataWithoutBody = RequestMetaData(endpoint: "https://jsonplaceholder.typicode.com/post/1",
                                                     method: .get,
                                                     body: nil,
                                                     headers: nil)
